...
;(function(exports) {
  ...
  Inputter.prototype = {
    ...
    isSequence: function(id) {
      return this._buttonListener.isSequence(id);
    },
  ...
  ButtonListener.prototype = {
    update: function(interval) {
      for (var i = 0; i < this._buttonQueue.length; i++) {
          var button = this._buttonQueue[i]
          this._buttonDownState = button > 0 // positive correlates with key press / as opposed to release
          this._buttonPressedState[i] = false; // end last tick's pressed states
          this._buttonSequencer.update(interval, button)
      }
    ...
    _down: function(buttonId) {
      ...
      if (this._buttonPressedState[buttonId] === undefined) { // start of new keypress
        ...
        this._buttonQueue.push(buttonId);  
    ...
    isSequence: function(id) {
        return this._buttonSequencer.isSequence(id);
    },
